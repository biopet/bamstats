...
#  About this tool
BamStats reports clipping stats, flag stats and mapping quality on a BAM file.

#  Documentation
For documentation and manuals visit the [readthedocs page](http://biopet-BamStats.readthedocs.io/en/latest/).
